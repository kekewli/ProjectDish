    ...
    public class RegisterViewModel : ViewModelBase
    {
        ...
        private async Task ExecuteRegister(object parameter)
        {
            ...
            if (!IsValidEmail(Email))
            {
                ...
                MessageBox.Show("Введите корректный Email с поддерживаемым доменом (mail.ru, gmail.com и др).",
            ...
            try
            {
                ...
                switch (result)
                {
                    ...
                    case 5:
                        ...
                        MessageBox.Show($"Данные не соответствуют требованиям сервера (Код ошибки: {result}).",
                                        "Ошибка", MessageBoxButton.OK, MessageBoxImage.Error);
                        break;
            ...
            catch (Exception ex)
            {
                ...
                MessageBox.Show("Произошла системная ошибка. Попробуйте позже.", "Ошибка", MessageBoxButton.OK, MessageBoxImage.Error);
            }
            finally
            {
                IsBusy = false;
